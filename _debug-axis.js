...
(function () {
  ...
  var CONFIG = {
    title: 'axis: corridor / fill (P7_VERT)',
    tabs: [],
    tab: null,
    onTab: null,
    sliders: [
      { key: 'corridorPx', label: 'corridor px (full height)', min: 100, max: 400, step: 5, value: 180, source: 'squareboundingbox.js:98 P7_AXIS_CORRIDOR_PX -> P7_VERT.corridorPx' },
      { key: 'fillRatio',  label: 'fill ratio', min: 0.5, max: 1, step: 0.02, value: 1, source: 'page7.js P7_VERT.fillRatio' },
      { key: 'rowJitter',  label: 'row jitter', min: 0, max: 6, step: 0.5, value: 0, source: 'page7.js P7_VERT.rowJitter' },
    ],
    colors: [],
    modes: [],
    mode: null,
    ...
    knobCols: 1,
    summary: function (v) {
      return 'corridor px: ' + v.corridorPx + ' (squareboundingbox.js:98 P7_AXIS_CORRIDOR_PX)\n' +
             'fill ratio: ' + v.fillRatio + ' (page7.js P7_VERT.fillRatio)\n' +
             'row jitter: ' + v.rowJitter + ' (page7.js P7_VERT.rowJitter)';
    }
  };
  // ------------------------------------------------------------ END CONFIG --
