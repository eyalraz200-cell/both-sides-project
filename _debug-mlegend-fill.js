...
(function (boot) {
  ...
  var CONFIG = {
    ...
    sliders: [],
    colors: [
      { key: 'fill', label: 'pill + sheet fill', value: '#ffffff', source: 'style.css — .fold6-mlegend-tab / .fold6-mlegend-card background' },
    ],
    modes: [], mode: null, toggles: [],
    apply: function (v) {
      style.textContent = '.fold6-mlegend-tab,.fold6-mlegend-card{background:' + v.fill + '!important}';
      if (typeof fold6MLegendPaintCard === 'function') fold6MLegendPaintCard(fold6MLegendOpenRaw);
    },
    init: null, custom: null,
    goTo: '#page-3', goLabel: '@fold4', onGo: null,
