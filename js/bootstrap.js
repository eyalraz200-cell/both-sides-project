Promise.all([
  ...
  document.fonts.load("400 16px 'Miriam Libre'"),
  document.fonts.load("300 16px 'Assistant'"),
  ...
  p12ShareInit();
  p12CardWidthFit();
  p12SpacingFit();            // #page-14's height = 50vh + half its card (house rhythm, page12.js)
