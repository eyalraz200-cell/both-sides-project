// ── @fold13 animations ───────────────────────────────────────────────────────
// Throughout this file, #page-12 is @fold13 — the closing statement card; the
// share block (@fold14, #page-13) and the outro/credits card (@fold15,
// #page-14) follow it. Every *scroll*
...
// #page-12's .page12-sticky-center is overridden to position:static — left
...
// (scrollY = #page-12's offsetTop, where the static wrapper's padding-top
...
// #page-12's height beyond the resting spot is trailing gap and doesn't
...
// #page-12's title is centred in a 100vh wrapper flush with the section top, so
// the *instant* real
...
// the user passes #page-12's scroll context, position:sticky releases and the
