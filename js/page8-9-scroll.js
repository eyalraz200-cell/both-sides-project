...
function page8CheckScroll() {
  ...
  // Mobile only: @fold12's pill band lands where the docked tooltip frame has
  // been sitting, so the frame steps down to p9DockTopM() (page9.js) to clear
  // it. That drop rides @fold11's own crossing rather than @fold12's stick, so
...
function page9UpdateFromScroll() {
  ...
  // fired here — it rides @fold11's title crossing in page8CheckScroll above.)
