...
`P7_POP_DURATION` 220 (one square), `P7_CHAIN_MAX_WAIT_MS` 700 (longest wall-clock wait a
chained month may have before the whole cascade speeds up — see [Timeline](Timeline.md)), `P8_TRANSITION_DURATION` 3000 (full blend into
