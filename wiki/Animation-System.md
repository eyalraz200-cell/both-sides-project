...
**Bigger canvas glides:** `P7_ANIM_TOTAL_DURATION` 2200 (one month's cascade, mobile; desktop plays each armed row centre → side over `P7_ROW_WAVE_MS` 600 + 220 ms pops, rows 40 ms apart),
