...
| `#page-12` (outro) frame / title | 366px copy + 40px side padding (**content-box** — widen the padding and the frame widens; `#page-12 .text-card` is `fit-content` so it stays centred) / 40px | `min(450px, 100vw-48px)` border-box / 28px |
